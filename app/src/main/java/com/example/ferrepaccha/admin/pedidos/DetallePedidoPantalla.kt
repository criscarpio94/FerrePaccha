...
import com.example.ferrepaccha.admin.productos.TarjetaProductoItem
...
fun DetallePedidoPantalla(
    ...
    Column(
        ...
        Column(
            ...
            // 3. SECCIÓN: PRODUCTOS DEL PEDIDO
            Text(
            ...
            // 4. TOTAL DESTACADO (Tarjeta Oscura)
            Card(
                modifier = Modifier.fillMaxWidth(),
            ...
            // 5. BOTÓN ACCIÓN: ACTUALIZAR ESTADO (Verde)
            Button(
                onClick = onActualizarEstadoClick,
                modifier = Modifier.fillMaxWidth().height(50.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color(0xFF2E7D32)), // Verde Bosque/Éxito
                shape = RoundedCornerShape(12.dp)
            ) {
    ...
    Card(
        ...
        Row(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                // Contenedor del emoji de la caja 📦
                Box(
                    modifier = Modifier
                        .size(48.dp)
