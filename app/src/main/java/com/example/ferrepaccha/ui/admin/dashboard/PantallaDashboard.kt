...
fun PreviewDashBoardSoporte() {
    PantallaDashboard(nombreAdmin = "Christopher Soporte", rolUsuario = "SOPORTE", onCerrarSesion = {}, onNavegarA = {})
}

@Preview(showBackground = true, name = "Vista como Gerente")
@Composable
fun PreviewDashBoardGerente() {
    PantallaDashboard(nombreAdmin = "Hernan Paccha", rolUsuario = "GERENTE", onCerrarSesion = {}, onNavegarA = {})
}

@Preview(showBackground = true, name = "Vista como Empleado")
@Composable
fun PreviewDashBoardEmpleado() {
    PantallaDashboard(nombreAdmin = "Jhony Coronel", rolUsuario = "EMPLEADO", onCerrarSesion = {}, onNavegarA = {})
}
